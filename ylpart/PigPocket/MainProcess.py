...
def totalforbankdeposit(name,bank):
    t_file = open('file/Transaction.txt', 'r')
    total = 0
    for trans in t_file:
        list = trans.split(',')
        if list[0] == name and list[2].startswith(bank.upper()):
            if list[4].lower()=="none" or list[4].lower()=="none\n":
                pass
            else:
                total += float(list[4])
    s = "%0.2f" % total
...
def totalforbankwithdraw(name,bank):
    t_file = open('file/Transaction.txt', 'r')
    total = 0
    for trans in t_file:
        list = trans.split(',')
        if list[0] == name and list[2].startswith(bank.upper()):
            if list[5].lower()=="none" or list[5].lower()=="none\n":
                pass
            else:
                total += float(list[5])
    s = "%0.2f" % total
